---@class rvim.util.bufdelete
---@overload fun(buf?: number|rvim.util.bufdelete.Opts)
...
---@class rvim.util.bufdelete.Opts
...
--- Delete all buffers
---@param opts? rvim.util.bufdelete.Opts
function M.all(opts)
